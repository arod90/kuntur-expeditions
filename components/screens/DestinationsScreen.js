...
function RegionHeader({ index, eyebrow, title, lead, meta }) {
  return (
    <div style={{ marginBottom: "var(--space-7)" }}>
      <RevealLine />
      <div className="k-sec-head k-region-head" style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "flex-end", paddingTop: 26 }}>
  ...
  return (
    <div>
      ...
      <Section tint="var(--ink-900)" style={{ paddingTop: 0 }}>
        ...
        <div className="k-gal" style={{ "--cols": "1.5fr 1fr", "--h": G1 }}>
        ...
        <div className="k-gal" style={{ "--cols": "1fr 1.5fr", "--h": G2 }}>
      ...
      <Section>
        ...
        <div className="k-gal" style={{ "--cols": "0.72fr 1.5fr 0.72fr", "--h": G1 }}>
        ...
        <div className="k-gal" style={{ "--cols": "1fr 1fr", "--h": G2 }}>
      ...
      <Section tint="var(--ink-900)">
        ...
        <div className="k-gal" style={{ "--cols": "1.5fr 0.75fr", "--h": G1 }}>
        ...
        <div className="k-gal" style={{ "--cols": "0.75fr 1fr 1fr", "--h": G2 }}>
